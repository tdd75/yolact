...
cig_butts_dataset = dataset_base.copy({
  ...
  'train_info': './dataset/cig_butts/train/coco_annotations.json',
  'train_images': './dataset/cig_butts/train/images/',
  'valid_info': './dataset/cig_butts/val/coco_annotations.json',
  'valid_images': './dataset/cig_butts/val/images/',
...
pigs_dataset = dataset_base.copy({
  ...
  'valid_images': './dataset/pigs/val/images/',
  'class_names': ('pig'),
  'label_map': { 1:  1 }
})
